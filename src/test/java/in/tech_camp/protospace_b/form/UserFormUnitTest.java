...
public class UserFormUnitTest {
    ...
    class 新規登録ができる場合 {
        ...
        public void emailとpasswordとpasswordConfirmationとnameとprofileとdepartmentとpositionが存在すれば登録できる() {
            Set<ConstraintViolation<UserForm>> violations = validator.validate(userForm,
                    ValidationOrder.Email1.class,
                    ValidationOrder.Password1.class,
    ...
    class 新規登録ができない場合 {
        ...
        public void emailが空の場合バリデーションエラーが発生する() {
            userForm.setEmail("");
            Set<ConstraintViolation<UserForm>> violations = validator.validate(userForm, ValidationOrder.Email1.class);
        ...
        public void passwordが5文字以下ではバリデーションエラーが発生する() {
            ...
            Set<ConstraintViolation<UserForm>> violations = validator.validate(userForm,
                    ValidationOrder.Password2.class);
