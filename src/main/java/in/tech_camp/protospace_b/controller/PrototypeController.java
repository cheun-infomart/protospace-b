...
public class PrototypeController {
  ...
  public String searchPrototypes(@RequestParam("keyword") String keyword, @RequestHeader(value = "X-Requested-With", required = false) String requestedWith, Model model) {
